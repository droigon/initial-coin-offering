...
export default function Home() {
  ...
  const getTotalTokensMinted = async () => {
    try {
      ...
      const _tokensMinted = await tokenContract.tokensPerNFT();
  ...
  return (
    <div>
      ...
      <div className={styles.main}>
        <div>
          <h1 className={styles.title}>Welcome to Droigon DROI!</h1>
          <div className={styles.description}>
            You can claim or mint DROI tokens here
          </div>
          {walletConnected ? (
            <div>
              <div className={styles.description}>
                {/* Format Ether helps us in converting a BigNumber to string */}
                You have minted {utils.formatEther(balanceOfCryptoDevTokens)} DROI Tokens
              </div>
              <div className={styles.description}>
                {/* Format Ether helps us in converting a BigNumber to string */}
      ...
      <footer className={styles.footer}>
        Made with &#10084;   <span><a href="https://droigon.com" target="blank"> Droigon</a></span>
      </footer>
    </div>
  );
}